                    ...
                    <form method="post" action="{{ route('posts.store') }}" class="form-horizontal" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="title" value="{{ old('title') }}" class="form-control" placeholder="{{ trans('main.title') }}" required>
                                    @if ($errors->has('title'))
                            ...
                            <div class="form-group{{ $errors->has('body') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea name="body" class="medium  medium-editor-textarea" required>{{ old('body') }}</textarea>
                                    @if ($errors->has('body'))
                                        <span class="help-block">
                            ...
                            <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="slug" value="{{ old('slug') }}" class="form-control" placeholder="{{ trans('main.slug') }}" required>
                                    @if ($errors->has('slug'))
                                        <span class="help-block">
                            ...
                            <div class="form-group{{ $errors->has('later_publish') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" id="later_publish" name="later_publish">
                                        <option value=""></option>
                                        <option value="yes" {{ old('later_publish') == 'yes' ? ' selected' : '' }}>{{trans('main.yes')}}</option>
                                        <option value="no" {{ old('later_publish') == 'no' ? ' selected' : '' }}>{{trans('main.no')}}</option>
                                    </select>
                                ...
                                <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" id="status" name="status">
                                            <option value=""></option>
                                            <option value="approved" {{ old('status') == 'approved' ? ' selected' : '' }}>{{trans('main.approved')}}</option>
                                            <option value="rejected" {{ old('status') == 'rejected' ? ' selected' : '' }}>{{trans('main.rejected')}}</option>
                                            <option value="pending" {{ old('status') == 'pending' ? ' selected' : '' }}>{{trans('main.pending')}}</option>
                                        </select>
                ...
                $('#later_publish_date_time').removeClass('hidden').html(`
                    ...
                    <div class="col-md-2">
                        <div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd" data-date-start-date="+0d">
                            <input type="text" value="{{ null !== old('publish_date') ? old('publish_date') : date('Y-m-d') }}" class="form-control" name="publish_date" readonly>
                    ...
                    <div class="col-md-2">
                        <div class="input-group">
                            <input type="text" name="publish_time" value="{{ old('publish_time') }}" class="form-control timepicker timepicker-24">
                            <span class="input-group-btn">
                                <button class="btn default" type="button">
